...
def _rules(kind, source_title, image_count, max_inline, has_brief):
    ...
    return (
        ...
        "7. CTA: 1 sampai 2 kalimat yang mengajak pembaca klik ikon WhatsApp di halaman ini untuk ngobrol dengan tim %s, dikaitkan dengan topik artikel. "
        "Jangan menulis nomor telepon atau link.\n"
